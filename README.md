...
An AI agent skill that gives Claude (and other AI coding assistants) the ability to generate professional UX research deliverables grounded in **Nielsen Norman Group (NNG) methodology**.
...
|---|---|
| **User Personas** | 3–5 NNG-style personas with goals, behaviors, pain points, motivations, context of use, and design implications |
...
│   ├── PERSONA-GUIDE.md              # Persona template & NNG methodology
...
The skill automatically identifies which deliverable you need, classifies your input fidelity (raw data vs. brief), and follows the relevant NNG template.
...
PRISM adds modest cost (~33 seconds, ~8K tokens) for a **64% quality improvement** on NNG methodology compliance, evidence-based structure, and actionable recommendations.
